...
/*
* Any listener that register itself using the TimeUtils class
* will get the notification when the FPS are correctly calculated.
* Usually once per second...
* */
public interface FPSUpdatedObserver {
    void GetFPS();
}
